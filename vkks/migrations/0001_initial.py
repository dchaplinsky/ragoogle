# Generated by Django 2.0.6 on 2018-07-05 09:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('paper', 'Паперова декларація'), ('electronic', 'Е-декларація')], max_length=10, verbose_name='Джерело')),
            ],
            options={
                'abstract': False,
            },
