...
logger = logging.getLogger("geoinf_licenses")


class GeoinfLicenseModel(AbstractDataset):
    def get_absolute_url(self):
        return reverse('geoinf_licenses>details', kwargs={'pk': self.id})
    ...
    def to_dict(self):
        ...
        companies = set([dt["owner_name"], dt["obj"]])
        companies |= generate_edrpou_options(dt["owner_code"])
        addresses = set([dt["owner_addr"]])
